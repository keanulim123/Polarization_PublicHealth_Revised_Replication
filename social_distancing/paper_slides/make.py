...
### FILL TABLES
gs.tablefill(template = 'code/text_tables.lyx', 
             input    = 'input/r_share_cutoff.txt input/share_drop_pop_restrictions.txt input/magnitude_stats.txt input/share_county_matched.txt input/share_precinct_matched.txt input/survey_stats.txt', 
             output   = 'output/text_tables_filled.lyx')
